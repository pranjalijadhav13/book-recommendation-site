...
if (strlen($q)>0) {
  ...
  for($i=0; $i<($x->length); $i++) {
   ...
   // }
    //else if($_POST['type'] == "Author") $y=$x->item($i)->getElementsByTagName('author');
    //else if($_POST['type'] == "Book Name") $y=$x->item($i)->getElementsByTagName('genre');
   //else if($_POST['type'] == "Age Group") $y=$x->item($i)->getElementsByTagName('agegroup');
